...
from core import Permissions, Emoji
...
class CommandHandler(commands.Cog):
	...
	async def on_app_command_error(self, inter: discord.Interaction, error: Exception): #Função que trata erros nos comandos slash.
		_P = Permissions()
